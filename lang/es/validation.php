...
// Diccionario de validación en español (F-002). Nativo de Laravel: activa el
// locale 'es' y todos los 422 de FormRequest salen con mensajes en español.
// Los mensajes custom de dominio (p. ej. WizardStepValidator de F-001) se
// conservan fuera de este diccionario.
...
return [
    ...
    'password' => [
        ...
        'uncompromised' => 'La contraseña aparece en una filtración de datos. Elige una contraseña distinta.',
    ],
